...
import NarrationPanel from '../components/tour/NarrationPanel'
...
const VIGNETTE = {
  ...
  background: 'radial-gradient(ellipse at 35% 50%, rgba(0,0,0,0) 38%, rgba(0,0,0,0.3) 100%)',
}
          ...
          <>
            ...
            >
              <TourCamera
                focusIds={focusIds}
                tick={tour.index}
                rightInset={Math.max(PANEL_MIN, window.innerWidth * PANEL_FRACTION)}
              />
            </FlowCanvas>
            <div style={VIGNETTE} />
            <NarrationPanel
