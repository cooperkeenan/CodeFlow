...
export default function EffectNode({ data, selected, sourcePosition, targetPosition }) {
  ...
  return (
    <div style={shellStyle(base, KIND_ACCENT.effect, { selected, highlighted: data.highlighted, dashed: data.dashed, focused: data.focused, dimmed: data.dimmed, adjacent: data.adjacent, entering: data.entering, enterDelay: data.enterDelay })}>
