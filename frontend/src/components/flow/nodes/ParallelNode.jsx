...
export default function ParallelNode({ data, selected, sourcePosition, targetPosition }) {
  ...
  const style = shellStyle(base, KIND_ACCENT.parallel, { selected, highlighted: data.highlighted, focused: data.focused, dimmed: data.dimmed, adjacent: data.adjacent, entering: data.entering, enterDelay: data.enterDelay })
  return (
