...
export default function StepNode({ data, selected, sourcePosition, targetPosition }) {
  ...
  return (
    <div style={shellStyle(base, KIND_ACCENT.step, { selected, highlighted: data.highlighted, dashed: data.dashed, focused: data.focused, dimmed: data.dimmed, adjacent: data.adjacent, entering: data.entering, enterDelay: data.enterDelay })}>
