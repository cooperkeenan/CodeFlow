...
from tracer.services.analysis.routes.django_url_pattern_parser import (
    include_target,
    is_include,
    route_view,
    urlpatterns_lists,
)
from tracer.services.analysis.routes.django_view_resolver import DjangoViewResolver
from tracer.services.analysis.syntax.paths import resolve_absolute
