...
from src.infrastructure.database.models import Base  # noqa: F401 — imports all models
...
# Set the database URL from our settings (override alembic.ini placeholder)
